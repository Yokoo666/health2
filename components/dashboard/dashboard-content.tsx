...
import { LogOut, User, Activity, Target, TrendingUp, MessageCircle, Bot, BarChart3, Flame, Download } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button onClick={openExportModal} variant="outline" className="gap-2 bg-transparent">
